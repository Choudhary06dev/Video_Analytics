    ...
    <div className="w-[280px] h-full flex flex-col bg-card/40 backdrop-blur-xl border-r border-border p-5 gap-6">
      ...
      <div className="relative">
        ...
        <input 
          ...
          className="w-full bg-white/5 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-[0.85rem] font-bold text-text-dark placeholder:text-text-gray/40 focus:outline-none focus:border-accent/40 transition-all"
        />
      </div>
