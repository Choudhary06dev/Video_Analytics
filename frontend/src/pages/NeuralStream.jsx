...
export default function NeuralStream() {
 ...
 return (
  <div className="max-w-[1600px] mx-auto flex flex-col gap-3 sm:gap-4 bg-bg font-sans transition-colors duration-300">
     ...
     <div className="flex items-center gap-2 flex-1 sm:flex-none">
      <div className="flex-1 sm:flex-none flex items-center gap-1.5 bg-surface border border-border rounded-lg px-2 h-[32px]">
       ...
       <select
        ...
        onChange={(e) => { setSelectedAreaId(e.target.value); setIsGlobalView(true); setActiveCamera(null); setLogsOffset(0); setCameraOffset(0); setLogs([]); }}
   ...
   {/* STREAMING MATRIX (Dynamic Focus vs Global) — Full Width */}
   <div className="w-full shrink-0 overflow-hidden bg-card rounded-lg border border-border shadow-premium p-2 sm:p-4 flex flex-col gap-2 sm:gap-4">
