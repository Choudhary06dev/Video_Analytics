    ...
    <div className="flex flex-col gap-8 pb-10 max-w-[1600px] mx-auto">
      ...
      <div className="grid lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-2">
          {tabs.map((tab) => (
            <button
              ...
              className={`w-full flex items-center justify-between px-5 py-4 rounded-lg transition-all group
                ${activeTab === tab.id 
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="bg-card rounded-lg border border-border shadow-premium overflow-hidden min-h-[500px]">
            {activeTab === 'profile' && (
              ...
              <div className="p-10 space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-400">
                <div className="grid gap-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-6 bg-bg/40 rounded-lg border border-border hover:bg-bg transition-colors group">
                      <div className="flex gap-5 items-center">
                        <div className={`w-12 h-12 rounded-lg flex items-center justify-center transition-colors shadow-sm
            ...
            {activeTab !== 'profile' && activeTab !== 'camera' && (
              <div className="py-32 text-center flex flex-col items-center gap-6">
                <div className="w-20 h-20 bg-bg rounded-lg flex items-center justify-center text-text-gray/20 border border-border shadow-inner">
                ...
                <button className="mt-4 px-6 py-2.5 bg-bg border border-border rounded-lg text-[0.75rem] font-black uppercase text-accent hover:border-accent transition-all">
                   Prioritize Build
                </button>
              </div>
            )}
          ...
          <div className="bg-gradient-to-r from-accent/10 to-transparent p-6 rounded-lg border border-accent/20 flex justify-between items-center group">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-lg bg-accent flex items-center justify-center text-white font-black text-sm">AI</div>
              <div>
