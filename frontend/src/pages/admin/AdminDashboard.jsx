      ...
      <div className="bg-[#0b1120] border border-white/5 rounded-lg overflow-hidden shadow-lg relative">
          <div className="p-4 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
              <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-[8px] font-black uppercase tracking-widest text-white/40">Secure Kernel Log</h3>
              </div>
              <div className="flex items-center gap-1.5">
                  <div className="w-1.5 h-1.5 bg-success rounded-full animate-pulse shadow-[0_0_8px_rgba(34,197,94,0.5)]"></div>
                  <span className="text-[8px] font-black uppercase tracking-widest text-success">Active</span>
              </div>
          </div>
          <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-[9px] text-white/30">
              <div className="space-y-2">
                  <p><span className="text-accent/50 mr-2">[08:42:12]</span> Decrypting handshake...</p>
                  <p><span className="text-success/50 mr-2">[08:42:15]</span> Protocol authorization: OK</p>
              </div>
              <div className="space-y-2 border-l border-white/5 pl-5">
                  <p className="text-red-500/60"><span className="text-red-500/50 mr-2">[08:42:25]</span> ALARM: Bypass attempt @ B</p>
                  <p><span className="text-accent/50 mr-2">[08:42:30]</span> Intelligence aggregation OK</p>
              </div>
          </div>
      </div>
    </div>
