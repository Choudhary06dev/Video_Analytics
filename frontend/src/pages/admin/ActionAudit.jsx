...
export default function ActionAudit() {
 ...
 return (
  <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-[1500px] mx-auto pb-20">
   ...
   {error ? (
    <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-10 text-center">
    ...
    <div className="grid lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-4 space-y-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center justify-between">
                ...
                <span className={`text-xs font-black ${m.color}`}>{m.count}</span>
              </div>
            ))}
          </div>
        ...
        <div className="bg-gradient-to-br from-accent/10 to-transparent border border-accent/10 rounded-lg p-6 text-center">
          <div className="w-10 h-10 bg-accent/10 rounded-lg flex items-center justify-center mx-auto mb-4 border border-accent/20">
            <Calendar className="w-5 h-5 text-accent"/>
          </div>
          <h3 className="text-sm font-black uppercase tracking-tighter text-text-dark mb-1">Genesis Protocol</h3>
