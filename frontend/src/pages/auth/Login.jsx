   ...
   <div className="flex items-center justify-center p-6 relative overflow-y-auto">
    <div className="w-full max-w-[400px]">
     ...
     <footer className="mt-8 text-center border-t border-white/5 pt-6">
      <p className="text-[9px] text-white/40 font-black uppercase tracking-[0.3em] mb-3">Unauthorized to System ?</p>
      <Link
       to="/register"
       className="inline-flex items-center gap-3 text-white font-black uppercase text-[9px] tracking-[0.4em] border-2 border-white/10 px-6 py-3 rounded-lg hover:border-accent/40 hover:text-accent hover:bg-white/5 transition-all hover:shadow-[0_0_20px_rgba(6,182,212,0.1)]"
      >
