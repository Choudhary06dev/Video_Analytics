...
const SCENARIO_METADATA = {
  ...
  'AGGRESSIVE_BEHAVIOUR_DETECTION': { icon: AlertTriangle, color: 'var(--color-warning)', image: '/assets/images/aggressive_behavior.png' },
  'WEAPON_DETECTION_GUN_KNIFE': { icon: Crosshair, color: 'var(--color-danger)', image: '/assets/images/weapon_detection.png' },
  'MULTIPLE_PERSONS_ENTRY_ON_SINGLE_ACCESS': { icon: Users, color: 'var(--color-warning)', image: '/assets/images/tailgating.png' },
  'BLACKLISTED_PERSON_ALERT_FACIAL_RECOGNITION': { icon: UserX, color: 'var(--color-danger)', image: '/assets/images/blacklist_alert.png' },
  'CROWD_DENSITY_OVERCROWDING_DETECTION': { icon: Users, color: 'var(--color-warning)', image: '/assets/images/crowd_density.png' },
  'VISITOR_COUNT_LIMIT_EXCEEDED': { icon: UserPlus, color: 'var(--color-warning)', image: '/assets/images/visitor_count.png' },
  'ENTRY_EXIT_TRACKING_OF_VISITORS_FACE_RECOGNITION': { icon: UserCheck, color: 'var(--color-accent)', image: '/assets/images/entry_exit_tracking.png' },
  'STAFF_PRESENCE_ABSENCE_AT_DUTY_POST': { icon: User, color: 'var(--color-accent)', image: '/assets/images/staff_presence.png' },
  'MOBILE_PHONE_USAGE_IN_RESTRICTED_AREAS': { icon: Phone, color: 'var(--color-warning)', image: '/assets/images/mobile_phone.png' },
  'FIRE_SMOKE_DETECTION': { icon: Flame, color: 'var(--color-danger)', image: '/assets/images/fire_smoke_detection.png' },
  'VEHICLE_DETECTION_TRACKING': { icon: Car, color: 'var(--color-accent)', image: '/assets/images/pakistan_car.png' },
  'UNAUTHORIZED_PARKING_AMBULANCE_BLOCKAGE': { icon: Truck, color: 'var(--color-warning)', image: '/assets/images/unauthorized_parking.png' },
  'CAMERA_OFFLINE_AND_RECORDING_FAILURE_ALERT': { icon: Video, color: 'var(--color-danger)', image: '/assets/images/camera_offline.jpg' },
  'BABY_MOVED_OUTSIDE_DESIGNATED_ROUTES': { icon: Baby, color: 'var(--color-danger)', image: '/assets/images/baby_moved.png' },
  'UNAUTHORIZED_PERSON_HANDLING_OR_CARRYING_BABY': { icon: Ban, color: 'var(--color-danger)', image: '/assets/images/unauthorized_person.jpg' },
  'BABY_LEFT_UNATTENDED': { icon: Package, color: 'var(--color-warning)', image: '/assets/images/baby_left_unattended.jpg' },
  'PATIENT_APPROACHING_EXIT_WITHOUT_DISCHARGE_CLEARANCE': { icon: Activity, color: 'var(--color-warning)', image: '/assets/images/patient_approaching_exit.jpg' },
  'MORE_THAN_ALLOWED_ATTENDANTS_DURING_NIGHT': { icon: Users, color: 'var(--color-warning)', image: '/assets/images/more_attendants_night.jpg' },
  'MOVEMENT_IN_CLOSED_DEPARTMENTS_AREAS': { icon: Building, color: 'var(--color-danger)', image: '/assets/images/movement_closed_areas.jpg' },
  'PERSON_CLIMBING_OR_JUMPING_OVER_BOUNDARY_WALL': { icon: Mountain, color: 'var(--color-danger)', image: '/assets/images/person_climbing_wall.jpg' },
};
