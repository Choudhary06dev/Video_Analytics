...
const SCENARIOS = [
  ...
  { id: 7, name: 'Visitor count limit (only 1 attendant per patient)', icon: UserPlus, color: 'var(--color-warning)', image: 'https://th.bing.com/th/id/OIP.2KxpZ7UmY1hIyHwZbJmL3QHaD4?w=299&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7', desc: 'Real-time counting for compliance.', status: 'good', health: 95.1 },
  ...
  { id: 12, name: 'Vehicle detection & tracking', icon: Car, color: 'var(--color-accent)', image: 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&q=80&w=800&q=90', desc: 'Tracks ambulance and vehicle arrivals at emergency bay.', status: 'excellent', health: 98.1 },
